...
describe("View sidebar settings", () => {
  ...
  it("lets display settings control whether the session list follows the active project", () => {
    ...
    expect(displaySettings).toContain('export type SessionListAllProjectsMode = "timeline" | "byProject";');
    expect(displaySettings).toContain("sessionListScope: SessionListScope;");
    expect(displaySettings).toContain("sessionListAllProjectsMode: SessionListAllProjectsMode;");
    expect(displaySettings).toContain('sessionListScope: "activeProject",');
    expect(displaySettings).toContain('sessionListAllProjectsMode: "timeline",');
    ...
    expect(displayPanel).toContain("settings.display.sessionListAllProjectsMode");
    expect(displayPanel).toContain("settings.display.sessionListAllProjectsTimeline");
    expect(displayPanel).toContain("settings.display.sessionListAllProjectsByProject");
    ...
    expect(chatView).toContain(":session-list-all-projects-mode=\"displaySettings.sessionListAllProjectsMode\"");
    ...
    expect(sessionPanel).toContain("sessionListAllProjectsMode?: SessionListAllProjectsMode;");
    expect(sessionPanel).toContain("groupByProject: groupSessionsByProject.value");
    ...
    expect(compactPicker).toContain("sessionListAllProjectsMode?: SessionListAllProjectsMode;");
    expect(compactPicker).toContain("groupRecentSessionsByProject");
    expect(compactPicker).toContain("recentSessionGroups");
    expect(compactPicker).toContain("session-compact-project-header");
    ...
    expect(zh).toContain('"settings.display.sessionListAllProjectsMode": "全部会话展示"');
    expect(zh).toContain('"settings.display.sessionListAllProjectsTimeline": "按时间"');
    expect(zh).toContain('"settings.display.sessionListAllProjectsByProject": "按项目"');
    ...
    expect(en).toContain('"settings.display.sessionListAllProjectsMode": "All-session layout"');
    expect(en).toContain('"settings.display.sessionListAllProjectsTimeline": "By time"');
    expect(en).toContain('"settings.display.sessionListAllProjectsByProject": "By project"');
